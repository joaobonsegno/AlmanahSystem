...
public class FormaPagamentoOLD extends javax.swing.JDialog {
    Integer formaPag;
    ...
    public FormaPagamentoOLD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormaPagamentoOLD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormaPagamentoOLD dialog = new FormaPagamentoOLD(new javax.swing.JFrame(), true);
