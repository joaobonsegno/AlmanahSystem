...
public class OLDNovaSobremesa extends javax.swing.JFrame {
 ...
 /*   
    public int produtoExiste(Integer idSelecionado){
        ...
        for (Produto p:GerenciadorComandas.comandasAbertas.get(GerenciadorComandas.indiceSelecionado-1).getItens()){
            if (p.getIdSistema() == idSelecionado){
                contador += 1;
                flag = false;
                break;
            }
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if (txtIdBebida.getText().equals("")){
            idSelecionado = (Integer)jtSobremesas.getValueAt(jtSobremesas.getSelectedRow(), 0);
        }else{
            id1 = txtIdBebida.getText();
            idSelecionado = Integer.parseInt(id1);
        }
        boolean flag = true;
...
//        criarTabelaNome(txtPesquisa.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OLDNovaSobremesa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OLDNovaSobremesa().setVisible(true);
            }
        });
    }
