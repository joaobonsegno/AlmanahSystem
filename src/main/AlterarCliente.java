...
public class AlterarCliente extends javax.swing.JFrame {
    ...
    public AlterarCliente() {
       ...
       txtNome.setText(GerenciadorClientes.clienteSelecionado.getNome());
       txtCpf.setText(GerenciadorClientes.clienteSelecionado.getCpf());
       txtEmail.setText(GerenciadorClientes.clienteSelecionado.getEmail());
       txtTelefone.setText(GerenciadorClientes.clienteSelecionado.getTelefone());
       txtCelular.setText(GerenciadorClientes.clienteSelecionado.getCelular());
       txtLogradouro.setText(GerenciadorClientes.clienteSelecionado.getLogradouro());
       txtNumero.setText(Integer.toString(GerenciadorClientes.clienteSelecionado.getNumero()));
       txtBairro.setText(GerenciadorClientes.clienteSelecionado.getBairro());
       txtCidade.setText(GerenciadorClientes.clienteSelecionado.getCidade());
       txtCep.setText(GerenciadorClientes.clienteSelecionado.getCep());
       txtComplemento.setText(GerenciadorClientes.clienteSelecionado.getComplemento());      
       cbUf.setSelectedItem(GerenciadorClientes.clienteSelecionado.getEstado().getNome());
       cbSexo.setSelectedItem(GerenciadorClientes.clienteSelecionado.getSexo());
       calendarNasc.setDate(Date.valueOf(GerenciadorClientes.clienteSelecionado.getDataNasc()));
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1110, 588));
        setMinimumSize(new java.awt.Dimension(1110, 588));
        setResizable(false);
        ...
        lblStringNovoFunc.setText("Alterar Cliente");
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                                ...
                                                .addComponent(txtCelular, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(62, 62, 62))
                                            .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                    .addComponent(txtNome, javax.swing.GroupLayout.DEFAULT_SIZE, 551, Short.MAX_VALUE)
        ...
        if (flag == 0){
            if(!(nome.equals("")|cpf.equals("")|sexo.equals(""))){
                try{
                    ...
                    GerenciadorClientes.clienteSelecionado.clonarCliente(cadastro);
                    ...
                    //c.setDataNasc(calendarNasc.getDateFormatString());
