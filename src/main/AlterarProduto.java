...
public class AlterarProduto extends javax.swing.JFrame {
    ...
    public AlterarProduto() {
        ...
        GerenciadorProdutos.prodSelecionado.limparMaterias();
        
        MateriaPrimaDAO materiaDao = new MateriaPrimaDAO();
        materiaDao.read(GerenciadorProdutos.prodSelecionado);
        CadastrarMateriaPrima.materiasSelecionadas.removeAll(CadastrarMateriaPrima.materiasSelecionadas);
        for (Produto p:GerenciadorProdutos.prodSelecionado.getMateriasPrimas()){
            CadastrarMateriaPrima.materiasSelecionadas.add(p);
        }
        atualizarLabel();
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(813, 619));
        setMinimumSize(new java.awt.Dimension(813, 619));
        setResizable(false);
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if(!(cat.equals("")|nome.equals(""))){
            try{
                ...
                // Pega os subprodutos (matérias-primas) do produto
                p.limparMaterias();
                MateriaPrimaDAO materiaDao = new MateriaPrimaDAO();
                materiaDao.deleteAll(p);
