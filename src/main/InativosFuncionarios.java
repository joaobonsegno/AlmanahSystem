...
public class InativosFuncionarios extends javax.swing.JDialog {    
    public FuncionarioDAO fDao = new FuncionarioDAO();
    
    public InativosFuncionarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void criarTabela(){
        ...
        for (Funcionario f : fDao.readInativos()){
            ordenador.add(f);
        }
    ...
    public void formatarTabela(){        
        jtFuncionarios.setRowHeight(28);
        jtFuncionarios.getColumn("CPF").setCellRenderer(centro);
        ...
        jtFuncionarios.getColumnModel().getColumn(2).setPreferredWidth(160);
        jtFuncionarios.getColumnModel().getColumn(3).setPreferredWidth(200);
        
        jtFuncionarios.getColumnModel().getColumn(0).setMinWidth(0);
        jtFuncionarios.getColumnModel().getColumn(1).setMinWidth(350);
        jtFuncionarios.getColumnModel().getColumn(2).setMinWidth(160);
        jtFuncionarios.getColumnModel().getColumn(3).setMinWidth(200);
        
        jtFuncionarios.getColumnModel().getColumn(0).setMaxWidth(0);
        jtFuncionarios.getColumnModel().getColumn(1).setMaxWidth(350);
        jtFuncionarios.getColumnModel().getColumn(2).setMaxWidth(160);
        jtFuncionarios.getColumnModel().getColumn(3).setMaxWidth(200);
    }
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(689, 420));
        setMinimumSize(new java.awt.Dimension(689, 420));
        setResizable(false);
        ...
        txtStringSuprimento.setText("Funcionários Inativos");
        ...
        jtFuncionarios.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(linha, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 689, Short.MAX_VALUE))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(linha1, javax.swing.GroupLayout.DEFAULT_SIZE, 689, Short.MAX_VALUE))
        );
    ...
    private void btnAtivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtivarActionPerformed
        if (jtFuncionarios.getSelectedRowCount() > 1){
            ...
            int reply = JOptionPane.showConfirmDialog(null, "Deseja realmente ativar o funcionário?","Ativação de Funcionário", JOptionPane.YES_NO_OPTION);
            if (reply == JOptionPane.YES_OPTION) {
                int id = (Integer)jtFuncionarios.getValueAt(jtFuncionarios.getSelectedRow(),0);
                fDao.setAtivo(id);
    ...
    private void jtFuncionariosFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtFuncionariosFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_jtFuncionariosFocusLost
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InativosFuncionarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InativosFuncionarios dialog = new InativosFuncionarios(new javax.swing.JFrame(), true);
