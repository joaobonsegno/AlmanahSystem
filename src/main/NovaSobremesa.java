...
public class NovaSobremesa extends javax.swing.JFrame {
    ...
    public void formatarTabela(){
        ...
        jtSobremesas.setRowHeight(26);
        jtSobremesas.getColumnModel().getColumn(0).setPreferredWidth(0); 
        jtSobremesas.getColumnModel().getColumn(1).setPreferredWidth(530);
        jtSobremesas.getColumnModel().getColumn(2).setPreferredWidth(60);
        jtSobremesas.getColumnModel().getColumn(3).setPreferredWidth(110);
        
        jtSobremesas.getColumnModel().getColumn(0).setMinWidth(0);
        jtSobremesas.getColumnModel().getColumn(1).setMinWidth(530);
        jtSobremesas.getColumnModel().getColumn(2).setMinWidth(60);
        jtSobremesas.getColumnModel().getColumn(3).setMinWidth(110);
        
        jtSobremesas.getColumnModel().getColumn(0).setMaxWidth(0);
        jtSobremesas.getColumnModel().getColumn(1).setMaxWidth(530);
        jtSobremesas.getColumnModel().getColumn(2).setMaxWidth(60);
        jtSobremesas.getColumnModel().getColumn(3).setMaxWidth(110);
   
        jtSobremesas.getColumnModel().getColumn(2).setCellRenderer(centro);
        jtSobremesas.getColumnModel().getColumn(3).setCellRenderer(direita);
    }
        ...
        if (evt.getKeyCode() == 10){
            ...
            if (cod == 0){
                ...
                try{
                    ...
                    boolean flag = true;
                    if (jtSobremesas.getSelectedRowCount() > 1){
