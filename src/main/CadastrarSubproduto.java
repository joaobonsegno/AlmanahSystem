...
public class CadastrarSubproduto extends javax.swing.JDialog {
    public ArrayList<Produto> listaProdutos = new ArrayList<>();
    public ProdutoDAO pDao = new ProdutoDAO();
    public static ArrayList<Produto> subprodutosSelecionados = new ArrayList<>();
    
    public CadastrarSubproduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setarSelecionado(){
        ...
        for (int i = 0; i < quantidadeDeProdutos; i++){
            ...
            for (Produto p : subprodutosSelecionados){
    ...
    private void initComponents() {
        ...
        setTitle("Subproduto de Prato");
        setMaximumSize(new java.awt.Dimension(516, 399));
        setMinimumSize(new java.awt.Dimension(516, 399));
        setResizable(false);
        ...
        txtStringSuprimento.setText("Subproduto de Prato");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastrarSubproduto dialog = new CadastrarSubproduto(new javax.swing.JFrame(), true);
